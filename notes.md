...
> "我在Inkdown项目中手写过RAG检索系统——BM25+Vector+RRF融合算法，理解文档分块、向量检索、重排序的完整链路。用Dify搭建运维知识库AI助手时，这些概念我不用从头学，Dify只是把代码变成了可视化配置。我搭了一个AI助手，导入常见运维FAQ，同事打开网页就能提问，降低了运维重复咨询量。"

### 待办提醒

- [ ] 面试话术大声念3遍到脱稿
- [ ] 用AI教练模板③做一次AI模拟面试（检验"真懂还是背的"）
- [ ] 简历更新成品2项目经验（主文档9.2节模板）
- [ ] 补充知识库FAQ文档（打印机/网络/系统各1份）
